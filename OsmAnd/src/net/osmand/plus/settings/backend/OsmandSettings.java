...
public class OsmandSettings {
	...
	public final OsmandPreference<Boolean> EXPLORE_HISTORY_ROW_COLLAPSED = new BooleanPreference(this, "explore_history_menu_collapsed", false).makeGlobal().makeShared();
